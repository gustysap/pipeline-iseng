pipeline {
    ...
    stages {
        ...
        post {
        failure {
            mail to: 'mohamad.haekal@itgroupinc.asia, gusty.prakoso@itgroupinc.asia',
        ...
        steps {
            ...
            def json = readJSON file: 'templates/templates.json'
            emailext (
            to: 'mohamad.haekal@itgroupinc.asia, gusty.prakoso@itgroupinc.asia',
